...
class ConfigurationManager:
    ...
    # now update the component ->  in component folder create data_ingestion.py
    #---->   data_validation 
    ...
    # now update the component ->  in component folder create data_validation.py  
    ...
    # now update the component ->  in component folder create data_transformation.py 
    ...
    # now update the component ->  in component folder create model_trainer.py  
